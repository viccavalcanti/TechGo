...
import avatarImg from '../../assets/avatar-Techgo.png';
import { Container, Content, AvatarInput, Background } from './styles';
    ...
    <Container>
      ...
      <Content>
        ...
        >
          ...
          <Input name="name" icon={FiUser} placeholder="Nome (Profissão)" />
